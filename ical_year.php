<?php
# This is a CSV dump of the shift cal event data
...
# viewmonth.php?month=07&year=2016#07-5451
	print "ATTACH:".CALURL."viewmonth.php?month=$mmonth&year=$myear#$mday-$id\n";
	print "END:VEVENT\n";
    }
    #ex:set sw=4 it=s:
?>
