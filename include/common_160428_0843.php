...
define("ADMINPASS", "funridesdaily");
...
define("PPSTART", "2016-06-09");	    # Start date, in MySQL format
define("PPEND", "2016-07-04");		    # End date, in MySQL format
define("PPSTART_MONTHDAY", "June 9");	    # Start date, in "Month Day" format
define("PPDAYS", 26);			    # Duration in days
//fixme needs to become july-aware
define("PPDATES", "June 9 - July 4");		    # Dates, in "Month Day-Day" format
define("PPURL", "viewpp2016.php");	    # URL of the festival calendar
define("PPSMALL", "images/pp2016.jpg");     # URL of the medium poster image
define("PPLARGE", "images/pp2016full.jpg"); # URL of the full-size poster image
